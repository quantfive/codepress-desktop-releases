...
- **Mobile-Optimized Interface** - Touch-friendly terminal experience designed for on-the-go use

## Use Cases

- Run commands on your home computer while traveling
- Check on long-running processes from your phone
- Quick server maintenance when away from your desk
...
4. Scan the QR code with the CodePress mobile app to connect
...
- **Wake your computer** - Use Chrome Remote Desktop to wake your sleeping Mac or PC before connecting with CodePress
...
CodePress Desktop includes auto-update functionality. When a new version is available, you will be notified and can update with a single click.
